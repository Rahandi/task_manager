                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ route('task.create') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> All Task</a></li>
                            </ul>
                        </li>
                        ...
                        @else
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    {{ Auth::user()->name }} | MHS <span class="caret"></span>
                                </a>
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
                    ...
                    <div class="design">
                        ...
                        <a target="_blank" href="#">Design and Development by Tim PBKK</a>
