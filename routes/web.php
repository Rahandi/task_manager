...
Route::group(['prefix' => 'mhs'], function(){
	Route::get('/tasks','TaskMhsController@index')->name('task_mhs.show') ;
	Route::get('/tasks/view/{id}','TaskMhsController@view')->name('taskmhs.view') ;
	Route::post('/tasks/view/submit','TaskMhsController@assign_task')->name('taskmhs.submit') ;
});

// Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function(){

Route::group(['prefix' => 'dosen','middleware' => 'is_dosen'], function(){
	// ===================== PROJECTS ======================
	...
	// nilai submit
	Route::post('/tasks/submit', 'TaskController@submit_nilai')->name('task.submitnilai'); 
